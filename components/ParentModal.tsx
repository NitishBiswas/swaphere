                ...
                {bottomButtons && <div className="flex flex-row items-center justify-end gap-5 p-4">
                    ...
                    {submitButton && (
                        <button
                            ...
                            className={`select-none h-[36px] w-28 justify-center items-center text-center border ${warning ? "border-error text-error bg-error/10 hover:bg-error" : "border-secondary text-secondary bg-secondary/10 hover:bg-secondary"}  rounded  flex items-center justify-center cursor-pointer hover:text-white`}
